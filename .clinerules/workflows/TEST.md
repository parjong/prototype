...
1. Read all the comments from the target pull request with Github CLI (gh)
   ...
   - SHOULD exclude "outdated" or "minimized" comments
...
2. For each comment that mentions "Cline", perform the following actions:
   ...
   - If the user explicitly asks a question or requests a comment:
     - All replies MUST start with "> Generated by Cline".
